            ...
            <v-row>
              <v-col cols="12" sm="10" md="6">
                <v-text-field outlined
                  label="Виртуальный хост"
                  v-model="host"
                  :rules="hostRules"
                />
              </v-col>
              <v-col cols="12" sm="6" md="6">
                <v-text-field outlined label="Описание" :rules="descriptionRules" v-model="description"/>
              </v-col>
              <v-col cols="12">
                <v-divider/>
              </v-col>
...
export default {
  data() {
    return {
      ...
      selectHTTPS: "http://",
      hostRules: [
        v => !!v || 'Заполните поле виртуального хоста',
      ],
      descriptionRules: [
        v => !!v || 'Заполните поле описания',
      ],
      httpRules: [
        v => (v && v.length >= 9) || 'Заполните поле'
      ],
      httpsRules: [
        v => (v && v.length >= 9) || 'Заполните поле'
      ],
